...
//import static sukarna.servlets.LogInProcess.globalemail;

/**
 *
 * @author shawontafsir
 */
public class ManagerLogInProcess extends HttpServlet {
     ...
     */
    //static String managerEmail=null;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean exist = db.existManager(email, password);
        if(exist)
        {
            //managerEmail = email;
